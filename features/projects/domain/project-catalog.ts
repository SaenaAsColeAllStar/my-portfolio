...
export type ProjectAccent = "sapphire" | "amber" | "violet";
...
export function parseProjectSlug(value: string | null): ProjectSlug | null {
  return isProjectSlug(value) ? value : null;
}

export function getProjectArchitecture(slug: ProjectSlug): ProjectArchitecture {
  return projectArchitectures[slug];
}
